...
//           href = "https://www.w3schools.com/html/" >{document.getElementById("email").placeholder}</a>!</div ></div>: < span ></span> }
//         <footer className="footer">
//           <h1 className="call-to-action">Join our newsletter</h1>
//           <form className="subscribe-form">
//             <label htmlFor="email"></label>
//             <div className="subcribe-call"><input type="email" id="email" className="input-field" onChange={this.handleChange} value={this.state.value} placeholder="    you@example.com"></input>
